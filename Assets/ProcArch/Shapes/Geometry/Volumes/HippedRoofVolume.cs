...
public class HippedRoofVolume : Volume
{
	...
	public float HipDistance { get; private set; }

	protected override void ApplyArguments (Argument[] args)
	{
		this.HipDistance = args.GetArgOrDefault("hipDist", 0.25f);
	}
	...
	protected override void OnBuildVolume(Argument[] args)
	{
		...
		this.Corners.Add(new Corner("corner-top-1", new Vector3(0f, 1f, this.HipDistance)));
		this.Corners.Add(new Corner("corner-top-2", new Vector3(0f, 1f, -this.HipDistance)));
