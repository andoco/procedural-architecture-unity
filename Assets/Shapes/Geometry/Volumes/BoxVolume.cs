...
public class BoxVolume : Volume
{
		...
		: base()
	{
		...
		// right
		this.Components.Add(new ScopeComponent("face-vert-1", new SimpleTransform(new Vector3(0.5f, 0.5f, 0f), Quaternion.LookRotation(Vector3.up, Vector3.right), new Vector3(1f, 0.1f, 1f)), x => x.ToZXY()));
		// left
		this.Components.Add(new ScopeComponent("face-vert-3", new SimpleTransform(new Vector3(-0.5f, 0.5f, 0f), Quaternion.LookRotation(Vector3.up, Vector3.left), new Vector3(1f, 0.1f, 1f)), x => x.ToZXY()));
		// forward
		this.Components.Add(new ScopeComponent("face-vert-4", new SimpleTransform(new Vector3(0f, 0.5f, 0.5f), Quaternion.LookRotation(Vector3.up, Vector3.forward), new Vector3(1f, 0.1f, 1f)), x => x.ToXZY()));
		// backward
		this.Components.Add(new ScopeComponent("face-vert-2", new SimpleTransform(new Vector3(0f, 0.5f, -0.5f), Quaternion.LookRotation(Vector3.up, Vector3.back), new Vector3(1f, 0.1f, 1f)), x => x.ToXZY()));
		// down
		this.Components.Add(new ScopeComponent("face-horiz-1", new SimpleTransform(new Vector3(0f, 0f, 0f), Quaternion.LookRotation(Vector3.forward, Vector3.down), new Vector3(1f, 0.1f, 1f)), x => x));
		// up
